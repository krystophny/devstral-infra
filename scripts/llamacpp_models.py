...
MODEL_SPECS: tuple[ModelSpec, ...] = (
    ...
    ModelSpec("qwen3.5-35b-a3b-q4", "qwen", "bartowski/Qwen_Qwen3.5-35B-A3B-GGUF", ("*Q4_K_M*.gguf",), True),
    ModelSpec("qwen3.6-35b-a3b", "qwen", "unsloth/Qwen3.6-35B-A3B-GGUF", ("*Q8_0*.gguf",), True),
    ModelSpec("qwen3.6-35b-a3b-q4", "qwen", "bartowski/Qwen_Qwen3.6-35B-A3B-GGUF", ("*Q4_K_M*.gguf",), True),
