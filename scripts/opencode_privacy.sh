...
MARK_BEGIN='# >>> devstral-infra opencode privacy >>>'
MARK_END='# <<< devstral-infra opencode privacy <<<'

SHELL_BLOCK=$(cat <<'EOF'
# Disables every non-LLM outbound call opencode makes. Managed by
# devstral-infra/scripts/opencode_privacy.sh. Do not edit by hand.
...
ENV_D_BLOCK=$(cat <<'EOF'
# Managed by devstral-infra/scripts/opencode_privacy.sh. Do not edit.
